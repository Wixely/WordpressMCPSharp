...
WordpressMCPSharp is licensed under the MIT License (see `LICENSE`). It
...
"WordPress" is a registered trademark of the WordPress Foundation. This project
is an independent MCP wrapper and is not affiliated with or endorsed by the
WordPress Foundation or Automattic.
