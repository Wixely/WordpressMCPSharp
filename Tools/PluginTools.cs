...
public static class PluginTools
{
    ...
    public static async Task<string> ActivatePlugin(
        ...
        CancellationToken ct = default)
        => await SetPluginStatus(svc, plugin, "active", "wp_activate_plugin", ct);
    ...
    public static async Task<string> DeactivatePlugin(
        ...
        [Description("Plugin file identifier, e.g. `akismet/akismet`.")] string plugin,
        CancellationToken ct = default)
        => await SetPluginStatus(svc, plugin, "inactive", "wp_deactivate_plugin", ct);
    ...
    private static async Task<string> SetPluginStatus(WordpressService svc, string plugin, string status, string operation, CancellationToken ct)
    {
        svc.EnsureFeature(svc.Options.EnablePlugins, "Plugin");
